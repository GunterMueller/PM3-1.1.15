...
/* Modified June 25, 2001, Rodney M. Bates, to compile on Linux
   Mandrake 8.0. Some typedef names have changed in header files, 
   and autoconfig didn't detect the now-renamed types. */
...
#define HAVE_GREGSET_T 
#define HAVE_FPREGSET_T 
/* RMB: ^ a hack.  Presumably, these should be set by autoconfig. */
